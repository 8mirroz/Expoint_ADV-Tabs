      ...
      <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input 
              type="text" 
              className="w-full bg-background border border-outline/50 rounded-lg px-4 py-3 focus:border-accent outline-none"
        ...
        >
          ...
          {file ? (
            ...
            <div>
              ...
              <label className="inline-block px-6 py-2 bg-on-surface text-surface rounded-lg cursor-pointer text-sm font-bold uppercase hover:bg-accent transition-colors">
        ...
        <button className="w-full py-4 mt-8 bg-accent text-background font-black uppercase tracking-widest rounded-lg hover:bg-accent/90 transition-colors">
