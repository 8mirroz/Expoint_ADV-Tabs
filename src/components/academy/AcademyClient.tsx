      ...
      <div className="container relative z-10 mx-auto px-4 md:px-8 max-w-6xl">
        ...
        <div className="articles-grid grid gap-8">
          {articles.map((article) => (
            ...
            >
              <div className="relative p-8 md:p-12 rounded-4xl bg-neutral-900/30 border border-white/5 hover:border-emerald-400/30 hover:bg-neutral-900/50 transition-all duration-500">
                <div className="flex flex-col md:flex-row gap-8 items-start md:items-center">
                  <div className="flex-1 space-y-4">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-white group-hover:text-emerald-400 transition-colors duration-300 tracking-tight">
                      {article.title}
                    </h2>
        ...
        <section className="mt-24 p-1 rounded-3xl bg-linear-to-r from-emerald-400/20 via-blue-500/20 to-emerald-400/20">
          <div className="bg-neutral-900 rounded-[calc(1.5rem-1px)] p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input 
                ...
                className="flex-1 bg-white/5 border border-white/10 rounded-xl px-5 py-3 text-white focus:outline-none focus:border-emerald-400 transition-colors"
              />
              <button className="bg-emerald-400 text-black font-bold px-8 py-3 rounded-xl hover:bg-emerald-300 transition-all">
                Подписаться
              </button>
            </div>
          </div>
