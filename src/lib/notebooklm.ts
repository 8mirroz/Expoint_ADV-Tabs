...
const KNOWLEDGE_BASE = [
  ...
  },
  {
    ...
    answer: 'Монтажная служба БУКВА СВЕТ работает круглосуточно. Мы имеем все необходимые допуски СРО и лицензии для работы на высоте. Возможен монтаж в день готовности изделия.',
...
export async function queryKnowledgeBase(
  ...
  return {
    answer: `К сожалению, в текущей базе знаний нет прямого ответа на запрос "${query}". Наш эксперт свяжется с вами для уточнения деталей. В целом, БУКВА СВЕТ специализируется на премиальном производстве наружной рекламы и навигационных систем.`,
