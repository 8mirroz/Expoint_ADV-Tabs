...
- Name: calculator.spec.ts >> Calculator full readiness >> calculator page handles query type and stale cart
- Location: tests/e2e/calculator.spec.ts:50:3
...
Locator: locator('[data-step="product"]')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('[data-step="product"]')
